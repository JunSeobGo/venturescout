...
```
# ── PostgreSQL (+pgvector, AWS RDS) ──
POSTGRES_HOST=venturescout-db.ctmg0gka282c.ap-northeast-1.rds.amazonaws.com
POSTGRES_PORT=5432
POSTGRES_DB=venturescout
POSTGRES_USER=postgres
POSTGRES_PASSWORD=
DATABASE_URL=postgresql://postgres:<password>@venturescout-db.ctmg0gka282c.ap-northeast-1.rds.amazonaws.com:5432/venturescout?sslmode=verify-full&sslrootcert=db/certs/rds-global-bundle.pem
```
...
```dbml
// VentureScout — RDS 실제 스키마 반영 (venturescout-db.ctmg0gka282c.ap-northeast-1.rds.amazonaws.com)
...
Expected:
```
venturescout-db.ctmg0gka282c.ap-northeast-1.rds.amazonaws.com
True
```
